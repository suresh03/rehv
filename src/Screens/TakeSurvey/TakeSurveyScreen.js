      ...
      return (
        ...
        >
          ...
          {backColor ? (
            <Image
            style={[
              { width: Scaler(24), height: Scaler(24),  position:'absolute', alignSelf:'flex-end', right:10 },
              
            ]}
            source={arrowbackgroundBlue}
            resizeMode={"contain"}
          />
          ):null}
    ...
    {loading ? (
      ...
      <View style={{}}>
        ...
        >
          ...
          >
            {renderQuestion()}
            <ScrollView contentContainerStyle={{flexGrow:1,  alignSelf:'center'}} showsVerticalScrollIndicator={false}>
            {renderOptions()}
            </ScrollView>
          </View>
