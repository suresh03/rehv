export const ENGLISH = {
  ...
  EMPLOYEE: "Employee",
  NO_COMMUNITY_POST:
    "You have no post in this Community right now. Come back later.",
  LEARN: "Learn",
  ...
  PERSONAL: "Personal",
  WORKER: "Worker",
  AGGRAGATE_DESC: "Aggregate Stats for all Communities",
  ...
  AGGRAGATE_TITLE: "Aggregate Stats",
  ...
  PROFILE: "Profile",
  GreatJobAchi:
    "Great job! You’ve broken the ice and earned yourself the “Experienced” ranking! It shows your commitment and engagement to your goals and peers and you deserve a great congratulations on the achievement!",
  AGGRAGATE_ALL: "Aggregate stats for all communities",
  badgesDesc:
